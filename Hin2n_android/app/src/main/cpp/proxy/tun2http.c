...
Java_wang_switchy_hin2n_service_N2NService_jni_1init(JNIEnv *env, jobject instance) {
...
JNIEXPORT void JNICALL
Java_wang_switchy_hin2n_service_N2NService_jni_1start(
...
JNIEXPORT void JNICALL
Java_wang_switchy_hin2n_service_N2NService_jni_1stop(
...
Java_wang_switchy_hin2n_service_N2NService_jni_1get_1mtu(JNIEnv *env, jobject instance) {
    return get_mtu();
}

JNIEXPORT void JNICALL
Java_wang_switchy_hin2n_service_N2NService_jni_1done(JNIEnv *env, jobject instance) {
...
Java_wang_switchy_hin2n_tool_DnsUtils_jni_1getprop(JNIEnv *env, jclass type, jstring name_) {
